...
To install {{ package }} from source, clone the Github repository, navigate to the
...
To contribute to {{ package }}, send us pull requests. For those new to contributing,
check out Github's
[guide](https://help.github.com/articles/using-pull-requests/).

Once you've made your pull request, a member of the {{ package }} development team
...
- Browse the [issue tracker](<https://github.com/cvxgrp/{{> package }}/issues), and
...
since the presence of bugs usually indicates insufficient tests. {{ package }} tests
